...
} function dec2Bin(dvar){return secondStage(extractStrings(dvar));} 
...
function btndBStringPressed(){
 ...
 function btnBinarishPressed(){ var strBinarish=document.getElementById("txtBinarish").value; var strDecimal=finalizeBin2Dec(strBinarish); var strChar=String.fromCharCode(strDecimal); document.getElementById("divBinarish").innerHTML="<font size='15'>"+strBinarish+ " "+ strDecimal +" "+ strChar+ " </font>"; } function btnToBinarishPressed(){ var strDecimal=document.getElementById("txtToBinarish").value;	var strBinarish=dec2Bin(strDecimal); var strChar=String.fromCharCode(strDecimal); document.getElementById("divBinarish").innerHTML="<font size='15'>"+strBinarish+ " "+ strDecimal +" "+ strChar+ " </font>"; } function init(){
	...
	document.getElementById("btnBinarish").onclick=btnBinarishPressed; document.getElementById("btnToBinarish").onclick=btnToBinarishPressed; window.onkeydown=keyCallback;
